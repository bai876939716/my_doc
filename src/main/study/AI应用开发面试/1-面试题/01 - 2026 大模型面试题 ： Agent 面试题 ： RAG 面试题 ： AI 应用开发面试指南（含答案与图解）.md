...
| ------------------------------------------------------------------ | ------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------- |
| [大模型基础面试题总结](./14%20-%20大模型基础面试题总结.md)               | 所有准备 AI 应用开发面试的人                           | Token、上下文窗口、采样参数、API 调用、流式输出、结构化输出、Function Calling、AI 应用评测                                 |
| [AI Agent 面试题总结](./15%20-%20AI%20Agent%20面试题总结.md)              | 准备 Agent、工具调用、工作流相关岗位的人               | Agent Loop、Memory、Prompt Engineering、Context Engineering、MCP、Agent Skills、Harness Engineering、Workflow、Graph、Loop |
| [RAG 面试题总结](./16%20-%20RAG%20面试题总结.md)                     | 准备知识库问答、企业 AI 应用、搜索增强生成相关岗位的人 | RAG 基础、Embedding、向量数据库、Chunk 策略、Hybrid Search、Query Rewrite、Rerank、GraphRAG、知识库更新与评测              |
| [AI 系统设计面试题总结](./17%20-%20AI%20系统设计面试题总结.md) | 2 年以上开发者、准备社招和系统设计面试的人             | 生产级 AI 应用架构、模型网关、Prompt 管理、RAG、Memory、Tool Calling、可观测、评测、安全合规、实时语音 Agent               |
...
如果你发现自己只能背定义，讲不出生产里的影响，建议先看：[大模型基础面试题总结](./14%20-%20大模型基础面试题总结.md)。
...
- [RAG 面试题总结](./16%20-%20RAG%20面试题总结.md)
- [AI Agent 面试题总结](./15%20-%20AI%20Agent%20面试题总结.md)
...
系统设计题建议直接看：[AI 系统设计面试题总结](./17%20-%20AI%20系统设计面试题总结.md)。
...
- Token、上下文窗口、采样参数不清楚，就看 [《LLM 运行机制》](../llm-basis/02%20-%20LLM%20运行机制：Token、上下文窗口与采样参数怎么影响输出.md)。
- Function Calling、Structured Outputs、MCP 边界不清楚，就看 [《大模型结构化输出详解》](../llm-basis/19%20-%20大模型结构化输出：从%20JSON%20契约到%20Function%20Calling%20落地.md) 和 [《万字拆解 MCP 协议》](../agent/22%20-%20什么是%20Model%20Context%20Protocol%20%28MCP%29？和%20Function%20Calling、Agent%20什么关系？.md)。
- RAG 效果优化说不清楚，就看 [《万字详解 RAG 检索优化》](../rag/09%20-%20万字详解%20RAG%20优化：从召回、重排到上下文工程的系统调优.md)。
- 生产级 AI 应用架构说不清楚，就看 [《AI 应用系统设计》](../system-design/10%20-%20AI%20应用系统设计：从%20Prompt%20Demo%20到生产级架构.md)。
...
- [大模型基础面试题总结](./14%20-%20大模型基础面试题总结.md)
- [AI Agent 面试题总结](./15%20-%20AI%20Agent%20面试题总结.md)
- [RAG 面试题总结](./16%20-%20RAG%20面试题总结.md)
- [AI 系统设计面试题总结](./17%20-%20AI%20系统设计面试题总结.md)
...
- 这篇文章是入口，帮你快速定位高频考点。
- [AI 应用开发专栏](../00%20-%20AI%20应用开发知识体系：大模型、Agent、RAG、MCP、Prompt%20工程与系统设计.md) 是正文，帮你把每个考点背后的原理、工程细节和实践方案讲透。
