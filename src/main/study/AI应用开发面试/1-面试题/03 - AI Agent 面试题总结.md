...
参考文章：[《AI Agent 核心概念：Agent Loop、Context Engineering、Tools 注册》](../agent/04%20-%20AI%20Agent%20核心概念：Agent%20Loop、Plan-and-Execute、A2A、Agentic%20Workflows、Tools%20注册.md)
...
参考文章：[《AI Agent 记忆系统：短期记忆、长期记忆与记忆演化机制》](../agent/21%20-%20AI%20Agent%20记忆系统：短期记忆、长期记忆与记忆演化机制.md)
...
参考文章：[《大模型提示词工程实践指南》](../agent/05%20-%20大模型提示词工程（Prompt%20Engineering）是什么？提示词技巧有哪些？.md)、[《上下文工程实战指南：让 Agent 少犯蠢的工程方法论》](../agent/06%20-%20上下文工程%28Context%20Engineering%29%20是什么？和%20Prompt%20Engineering%20有什么区别？.md)
...
参考文章：[《深入理解 MCP 协议：一次开发，多处复用》](../agent/22%20-%20什么是%20Model%20Context%20Protocol%20%28MCP%29？和%20Function%20Calling、Agent%20什么关系？.md)、[《Agent Skills 是什么？和 Prompt、MCP 到底差在哪？》](../agent/23%20-%20Agent%20Skills%20是什么？和%20Prompt、MCP%20到底差在哪？.md)
...
参考文章：[《一文搞懂 Harness Engineering：六层架构、上下文管理与一线团队实战》](../agent/24%20-%20一文搞懂%20Harness%20Engineering：六层架构、上下文管理与一线团队实战.md)
...
参考文章：[《AI 工作流中的 Workflow、Graph 与 Loop：从概念到实现》](../agent/25%20-%20AI%20工作流中的%20Workflow、Graph%20与%20Loop：从概念到实现.md)
