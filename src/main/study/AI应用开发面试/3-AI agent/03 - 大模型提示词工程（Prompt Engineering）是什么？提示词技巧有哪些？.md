...
> 前置知识：本文默认你已经理解 Token、上下文窗口、Temperature、Top-p 等 LLM 底层概念。如果还不熟，可以先看[《万字拆解 LLM 运行机制：Token、上下文与采样参数》](../llm-basis/02%20-%20LLM%20运行机制：Token、上下文窗口与采样参数怎么影响输出.md)。
...
关于 Context Engineering 的详细介绍，推荐阅读这篇：[上下文工程(Context Engineering) 是什么？和 Prompt Engineering 有什么区别？](./06%20-%20上下文工程%28Context%20Engineering%29%20是什么？和%20Prompt%20Engineering%20有什么区别？.md)
